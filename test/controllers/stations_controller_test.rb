...
class StationsControllerTest < ActionController::TestCase
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post :create, station: { name: @station.name, number: @station.number, tariff_zone_id: @station.tariff_zone_id }
    end
  ...
  test "should update station" do
    patch :update, id: @station, station: { name: @station.name, number: @station.number, tariff_zone_id: @station.tariff_zone_id }
    assert_redirected_to station_path(assigns(:station))
  end
